...
class ApiService {
  ...
  Future<Map<String, dynamic>> login(String username, String password) async {
    try {
      print(
          'Attempting login to: ${ApiConfig.apiBaseUrl}${ApiConfig.loginEndpoint}');
      print('Login data: username=$username');
      ...
      // Handle session-based authentication response
      if (response['success'] == true) {
        // For session-based auth, cookies are automatically managed
        // We just store a flag to indicate authentication
        await _saveAuthToken('session_authenticated');
        return response;
      } else {
