...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _refreshData() async {
    await context.read<DashboardProvider>().refreshStats();
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    mainAxisSpacing: 16,
                    childAspectRatio:
                        1.2, // Increased from 1.5 to give more height
                    children: [
                      StatCard(
                        title: 'Total Users',
